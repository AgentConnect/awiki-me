...
Map<String, Object?> genericCliRuntimeCardDiagnostics({
  ...
  String attentionState = 'none',
  int attentionItemCount = 0,
  String attentionNextAction = 'none',
  ...
  return <String, Object?>{
    'config_summary': <String, Object?>{
      'runtime_card': <String, Object?>{
        ...
        'operational_state': operationalState ?? lifecycleState,
        ...
        'attention_next_action': attentionNextAction,
...
class FakeAwikiGateway implements AwikiGateway, AwikiAccountGateway {
  ...
  Future<List<ChatMessage>> fetchDmHistory(String peerDid) async {
    ...
    return _directHistoryForPeer(dmHistoryByPeerDid, resolvedPeerDid) ??
        _directHistoryForPeer(dmHistoryByPeerDid, peerDid) ??
        const <ChatMessage>[];
  }
...
class FakeNotificationFacade implements NotificationFacade {
  ...
  int structuredNotificationCount = 0;
  StructuredNotification? lastStructuredNotification;
  StructuredNotificationEligibility structuredEligibility =
      StructuredNotificationEligibility.allowed;
  StructuredNotificationSubmission structuredSubmission =
      StructuredNotificationSubmission.submitted;
  ...
  Future<StructuredNotificationSubmission> showStructuredNotification(
    ...
    structuredNotificationCount += 1;
    lastStructuredNotification = notification;
