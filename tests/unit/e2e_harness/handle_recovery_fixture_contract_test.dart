...
Map<String, String> _localRawReferences() => <String, String>{
  ...
  'runtime_handle': 'runtime.example',
  'group_display_name': 'Recovery group',
  'group_description': 'Recovery group description',
  'group_role': 'owner',
  'group_membership_status': 'active',
  'group_owner_role': 'owner',
  'group_owner_membership_status': 'active',
  'group_peer_role': 'member',
  'group_peer_membership_status': 'active',
