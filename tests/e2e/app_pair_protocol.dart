...
const Map<String, Set<String>> _checkpointFieldsByRoute = <String, Set<String>>{
  ...
  'joiner\u0000content_postjoin_visible': <String>{},
  'joiner\u0000content_group_reverse_sent': <String>{'messageId'},
  'admin\u0000content_group_reverse_visible': <String>{},
  'admin\u0000content_incoming_sent': <String>{
    'directMessageId',
    'groupMessageId',
  },
  'joiner\u0000content_incoming_visible': <String>{},
  'joiner\u0000content_unread_visible': <String>{},
  'admin\u0000content_unread_visible': <String>{},
