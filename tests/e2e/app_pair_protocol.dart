...
const Map<String, Set<String>> _checkpointFieldsByRoute = <String, Set<String>>{
  'admin\u0000acp_runtime': <String>{'agentDid', 'handle'},
  'admin\u0000acp_chat_ready': <String>{},
  'joiner\u0000acp_chat_ready': <String>{},
  'admin\u0000acp_answer_ready': <String>{'questionId', 'runId'},
  'joiner\u0000acp_answer_ready': <String>{'questionId', 'runId'},
  'admin\u0000acp_answer_go': <String>{'at'},
  'admin\u0000acp_answer_done': <String>{'reply', 'remoteId'},
  'joiner\u0000acp_answer_done': <String>{'reply', 'remoteId'},
  'admin\u0000acp_queue_ready': <String>{},
  'joiner\u0000acp_queue_ready': <String>{},
  'admin\u0000acp_waiting': <String>{'runId'},
  'joiner\u0000acp_waiting': <String>{'runId'},
  'admin\u0000acp_restart_paused': <String>{},
  'joiner\u0000acp_restart_paused': <String>{},
  'admin\u0000acp_queue_done': <String>{'reply', 'remoteId'},
  'joiner\u0000acp_queue_done': <String>{'reply', 'remoteId'},
