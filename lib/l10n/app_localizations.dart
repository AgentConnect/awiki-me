...
abstract class AppLocalizations {
  ...
  /// No description provided for @localCredentialIndexInvalid.
  ///
  /// In zh, this message translates to:
  /// **'本地凭证索引格式不正确。'**
  String get localCredentialIndexInvalid;

  /// No description provided for @localCredentialIndexMissingCredentials.
  ///
  /// In zh, this message translates to:
  /// **'本地凭证索引缺少 credentials。'**
  String get localCredentialIndexMissingCredentials;

  /// No description provided for @credentialIndexEntryInvalid.
  ///
  /// In zh, this message translates to:
  /// **'凭证索引项格式不正确：{key}'**
  ...
  ///
  /// In zh, this message translates to:
  /// **'AWiki Me 当前未接入 DID 注册插件（{authHint}注册）。请先使用 Python 脚本注册并导入会话，或接入原生插件后再在 App 内完成注册。'**
