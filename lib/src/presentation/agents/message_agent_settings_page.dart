        ...
        children: <Widget>[
          ...
          _MessageAgentFactGrid(
            rows: <_MessageAgentFact>[
              _MessageAgentFact(
                '运行 Daemon',
                daemon == null ? '未选择' : AgentDisplayName.title(daemon),
              ),
              ...
              _MessageAgentFact(
                'Daemon 版本',
                daemon == null ? '未知' : _daemonRuntimeSummary(daemon),
              ),
              _MessageAgentFact(
                '安全 bootstrap',
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          const _MessageAgentLimitRow(
            ...
            text: '只读取可处理的普通 direct text；不处理 Direct / Group E2EE 明文。',
          ),
          const _MessageAgentLimitRow(
