...
dart run tests/e2e/runner.dart --case multi-device-app-pair-recovery-registration-rejoin --config <explicit-awiki-info-config.yaml>
```
...
精确 case `multi-device-app-pair-recovery-registration-rejoin`
