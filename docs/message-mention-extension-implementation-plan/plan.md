...
| System Test | 覆盖 App 发群 mention、App 高亮、Daemon 被 `@agents` / 单个 agent 唤起。 | `awiki-system-test/`、`awiki-me/tests/e2e_test/` |
...
| App unit/widget | `cd awiki-me && flutter test tests/unit_test` | mention draft、候选、发送 mapper、高亮 widget 测试通过。 |
...
- 本阶段修改文件：`awiki-cli-rs2-group/docs/api/im-core-interface/04-message-interface.md`、`awiki-cli-rs2-group/docs/flutter-sdk/awiki-im-core-flutter-sdk.md`、`awiki-me-group/docs/testing.md`、`awiki-me-group/tool/desktop_cli_peer_e2e_runner.dart`、`awiki-me-group/tests/integration_test/desktop_cli_peer/*`、本 Plan / Step05 ledger。
