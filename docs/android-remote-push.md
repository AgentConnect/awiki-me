...
No offline provider queue is enabled for Notify; 120-second freshness prevents historical ringing. Full task-to-phone E2E, existing warm-open Core errors and historical mute migration remain separate acceptance items. The Debug probe is not the product path. Development changes do not authorize release or deployment.
