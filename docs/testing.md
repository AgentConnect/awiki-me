...
release/0910 的 PR CI 显式选择 AWIKI_SOURCE_INTEGRATION=1，固定 Core consumer 1a7379111826976991cefe185414fe90fc449fe2；其 source manifest 固定 SDK 527146e3d74437bb3b74f064b50def8d22f4b7e0，使用配套提交锁。手动验证可选 sdk_dependencies=source/registry，默认 source；validation_only=true 保持禁止远端账号/OTP job。正式 package workflow 不变，开发不提前发布 SDK。
